...
import json
import asyncio
class socketServerGeneral(Thread):
    def __init__(self, host, port):
        Thread.__init__(self)
        self.host = host
        self.port = port
        self.log = logging.getLogger("socketServerGeneral")
    ...
    def run(self):
        print("entrando a run socket general")
    ...
    def process_message(self, task):
        ...
        self.broadcast("respondiendo el mensaje")
